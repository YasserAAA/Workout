...
export const Workout = {
    ...
    finishWorkout(state) {
        ...
        // Calculate total workout time, subtracting background pause time
        const totalWorkoutTime = Date.now() - state.workoutStartTime - state.totalPausedTime - state.totalBackgroundTime;
        ...
        console.log('Workout time calculation:', {
            ...
            pausedTime: state.totalPausedTime,
            backgroundTime: state.totalBackgroundTime,
